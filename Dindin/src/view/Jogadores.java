...
public class Jogadores extends JPanel {
			...
			public void actionPerformed(ActionEvent arg0) {
				try {
					...
					if (new Jogando().tamanho() < new Jogando().getMIN()) {
						JOptionPane.showMessageDialog(null, "Inicie com ao menos 1 Jogador para come�ar!", "Aviso",
	...
	private class NomeGrandeException extends Exception{
		...
		public NomeGrandeException(){
			msg = "Um ou mais nomes digitados excedeu os limites, insira um nome menor com, no m�ximo, 23 caracteres";
		}
